...
def main():
    ...
    level = 0
    lives = 5
    main_font = pygame.font.SysFont("courier", 35, bold=1)
    lost_font = pygame.font.SysFont("courier", 100, bold=2)
    ...
    def redraw_window():
        ...
        if lost:
            ...
            WIN.blit(lost_label, (WIDTH/2 - lost_label.get_width()/2, HEIGHT/2 - 20))
